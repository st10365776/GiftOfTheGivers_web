    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VolunteerProjectID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VolunteerProjects", x => x.VolunteerProjectID);
                    table.ForeignKey(
                        name: "FK_VolunteerProjects_ReliefProjects_ProjectID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerProjects_VolunteerID",
                table: "VolunteerProjects",
                column: "VolunteerID");
